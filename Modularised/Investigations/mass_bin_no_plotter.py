...
PNN_pos_cg_bounds = np.load("data/PNN_mb_pos_cg_bounds.npy")
PNN_pos_ctg_bounds = np.load("data/PNN_mb_pos_ctg_bounds.npy")

NN_pos_cg_bounds = np.load("data/NN_mb_pos_cg_bounds.npy")
NN_pos_ctg_bounds = np.load("data/NN_mb_pos_ctg_bounds.npy")
...
# Plot for cg
ax1.plot(mass_bin_values, PNN_pos_cg_bounds, marker='o', linestyle='-', color='tab:blue', label='PNN')
ax1.plot(mass_bin_values, NN_pos_cg_bounds, marker='o', linestyle='--', color='tab:orange', label='NN')
ax1.set_ylabel(r'Positive $c_g$ Bound', fontsize=font_size)
ax1.set_title(r'Positive $c_g$ and $c_{tg}$ Bounds vs Number of Mass Bins', fontsize=17)
ax1.grid(True)
...
# Plot for ctg
ax2.plot(mass_bin_values, PNN_pos_ctg_bounds, marker='o', linestyle='-', color='tab:blue', label='PNN')
ax2.plot(mass_bin_values, NN_pos_ctg_bounds, marker='o', linestyle='--', color='tab:orange', label='NN')
ax2.set_ylabel(r'Positive $c_{tg}$ Bound', fontsize=font_size)
ax2.set_xlabel('Number of Mass Bins', fontsize=font_size)
ax2.grid(True)
...
# Set x-axis ticks
#ax2.set_xticks(mass_bin_values)
...
# Formatting
plt.tight_layout()
plt.savefig(thesis_plot_path + "/WC_vs_no_of_mass_bins.pdf")
plt.show()