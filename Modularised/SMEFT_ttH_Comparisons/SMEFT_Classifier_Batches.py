...
plt.hist(
    y_proba[y_test == 1], bins=50, range=(0, 1), density=plot_fraction, histtype="step", linewidth=2,
    label=f"SMEFT $(c_g, c_{{tg}}) = ({cg}, {ctg})$"
)
plt.hist(
    y_proba[y_test == 0], bins=50, range=(0, 1), density=plot_fraction, histtype="step", linewidth=2,
