...
for i in range(len(ctg_values)):
    ...
    df_part["ctg"] = ctg_values[i]
    df_part["cg"] = cg_values[i]
    ...
    # Apply reweighting
    df_part_smeft["true_weight"] = add_SMEFT_weights_PNN(df_part_smeft)
...
torch.save(model_ckpt, "data/neural_network_parameterised_turbo.pth")
